import { ArchiveBoxIcon, ArrowDownIcon, ArrowUpIcon, MagnifyingGlassIcon } from '@heroicons/react/20/solid'
...
export default function Stats() {
  ...
  const getAllProduct = trpc.products.getAll.useQuery();
      ...
      <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-500">Products</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p className="text-2xl font-semibold text-gray-900">{getAllProduct.data?.length}</p>
            {/* <p
        ...
        >
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-500">Orders</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
